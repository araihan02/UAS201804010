...
class RvDataIcecreamAdapter(private val listDataku: ArrayList<DataModelIcecream>): RecyclerView.Adapter<RvDataIcecreamAdapter.CardViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CardViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.rvdata_icecream_item, parent, false)
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.btndelete.setOnClickListener {
            ...
            adapterDBHelper.deleteIcecream(dataku.id)
            listDataku.removeAt(position)
            notifyDataSetChanged()
        }

        holder.btnupdate.setOnClickListener {
            val pindahUpdAc = Intent(holder.itemView.context, UpdateIcecream::class.java)
            val bundle = Bundle()
